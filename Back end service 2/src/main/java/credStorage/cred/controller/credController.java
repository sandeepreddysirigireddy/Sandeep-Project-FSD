...
return ResponseEntity.badRequest().body("Credential Name is empty after sanitization");


if(credDto.getPassword().length()==0)
return ResponseEntity.badRequest().body("Credential password is empty after sanitization");

if(credDto.getUserName().length()==0)
return ResponseEntity.badRequest().body("Credential user name is empty after sanitization");
